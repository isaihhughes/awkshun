...
let primaryImages = [IMG_7792.jpg];
let titles = ["Custom White Pants"];
let subtitles = ["Hand Painted"];
let details = ["Size 33 Waist, 32 Leg"];
let secondaryImages = [IMG_7785.jpg];
let startingPrices = [55];
let endTimes = [1658879999]; // Make sure to fix these to UTC time so they don't change with the users timezone
